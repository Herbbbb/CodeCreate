 ...
 * @version 1.0
 * @date 2020/8/18 0018 14:04
 * @Desc
 */
public class SocketUtilCreater extends BaseCreater {

    public SocketUtilCreater() {
        super.initReader();
        setPathKey("util");
        setTemplatePath(PathSetting.socketTemplate);
    }

    @Override
    public void executeCreateTask(Entity entity) {
        entity.setEntityName("SocketUtil");
