 ...
 * @version 1.0
 * @date 2020/8/18 0018 14:09
 * @Desc
 */
public class LogFactoryCreater extends BaseCreater {

    public LogFactoryCreater() {
        super.initReader();
        setPathKey("util");
        setTemplatePath(PathSetting.logFactoryTemplate);
    }

    @Override
    public void executeCreateTask(Entity entity) {
        entity.setEntityName("LogFactory");
