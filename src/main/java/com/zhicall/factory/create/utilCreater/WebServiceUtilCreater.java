 ...
 * @version 1.0
 * @date 2020/8/17 0017 16:01
 * @Desc
 */
public class WebServiceUtilCreater extends BaseCreater {

    public WebServiceUtilCreater() {
        super.initReader();
        setPathKey("util");
        setTemplatePath(PathSetting.webServiceTemplate);
    }

    @Override
    public void executeCreateTask(Entity entity) {
        entity.setEntityName("WebServiceUtil");
