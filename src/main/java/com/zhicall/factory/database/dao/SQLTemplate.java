...
import com.zhicall.factory.entity.FieldConstraint;
...
public class SQLTemplate {
	...
	public static String createTableSQL(Entity entity){
		List<Field> primaryFieldList = new ArrayList<>();
		List<Field> foreignFieldList = new ArrayList<>();
		List<Field> uniqueFieldList = new ArrayList<>();
		List<Field> checkFieldList = new ArrayList<>();
