            ...
            switch (fieldSteate) {
                ...
                case 2: {
                    ...
                    for (int index = 0; index < editConstraintList.size(); index++) {
                        ...
                        if (s.equals("p")) {
                            sql = SQLTemplate.addColumnPrimaryKeySQL(tableName, field);
                            sqlList.add(sql);
                        }
                        if (s.equals("u")) {
                        ...
                        if (s.equals("f")) {
                            sql = SQLTemplate.addColumnForignKeySQL(tableName, field, field.getForignCondition());
                            sqlList.add(sql);
                        }
                        if (s.equals("c")) {
                            sql = SQLTemplate.addColumnCheckSQL(tableName, field, field.getCheckCondition());
                            sqlList.add(sql);
                        }
                        if (s.equals("d")) {
                            sql = SQLTemplate.addColumnDefaultSQL(tableName, field, field.getDefaultCondition());
                            sqlList.add(sql);
                        }
                    }
                }
                ...
                case 3: {
                    ...
                    for (int index = 0; index < editConstraintList.size(); index++) {
                        String s = editConstraintList.get(index);
                        if (s.equals("p")) {
                            sql = SQLTemplate.dropColumnPrimaryKeySQL(tableName, field);
                            sqlList.add(sql);
                        }
                        if (s.equals("u")) {
                        ...
                        if (s.equals("n")) {
                            sql = SQLTemplate.dropColumnNotNullSQL(tableName, field);
                            sqlList.add(sql);
                        }
                        if (s.equals("f")) {
                            sql = SQLTemplate.dropColumnForignKeySQL(tableName, field);
                            sqlList.add(sql);
                        }
                        if (s.equals("c")) {
                        ...
                        if (s.equals("d")) {
                            sql = SQLTemplate.dropColumnDefaultSQL(tableName, field);
                            sqlList.add(sql);
                        }
                    }
                }
